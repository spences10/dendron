(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://dendron.vercel.app/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://dendron.vercel.app/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://dendron.vercel.app/assets/css/just-the-docs-' + theme + ".css"
      );
    };
